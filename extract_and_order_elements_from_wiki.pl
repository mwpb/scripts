...
my $path = '/Users/mat/@@files/vimwiki';
...
foreach my $file (@files)
{
	foreach my $element (keys %elements) #Put found elements in appropriate position in index.
	{
		...
		tie my @lines , 'Tie::File' , '/Users/mat/@@files/vimwiki/'."$file" or die "Cannot tie file: $!";
...
tie my @index_file , 'Tie::File' , '/Users/mat/@@files/vimwiki/index.wiki' or die "Cannot tie file: $!";
@index_file = ('=Index=', '');
